...
public enum Ground implements Tile {
	...
	BINARY_3(TerrainType.MYSTERY), T5(TerrainType.CAVE), GRASS_1(TerrainType.GRASS), GRASS_2(
			TerrainType.GRASS), GRASS_3(TerrainType.GRASS), GRASS_4(TerrainType.GRASS), GRASS_5(
